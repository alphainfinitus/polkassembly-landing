				...
				<div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
					<div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
						...
						<div className='md:-mt-5'>
							...
							<ul className="ml-0 md:ml-3 flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
								<li>
									<a
						...
						>
							<div className="text-center sm:text-left">
								...
								<nav className="mt-8">
									<ul className="space-y-4 text-sm">
										<li>
											<a className="text-white transition hover:text-white/60" rel="noopener noreferrer" target='_blank' href="https://polkadot.polkassembly.io/terms-and-conditions">
												Terms and Condition
											</a>
										</li>

										<li>
											<a className="text-white transition hover:text-white/60" rel="noopener noreferrer" target='_blank' href="https://github.com/polkassembly/polkassembly.github.io/issues">
												Report an Issue
											</a>
										</li>
									</ul>
							...
							<div className="text-center sm:text-left">
								...
								<nav className="mt-8">
									<ul className="space-y-4 text-sm">
										<li>
											<a className="text-white transition hover:text-white/60" rel="noopener noreferrer" target='_blank' href="https://polkadot.polkassembly.io/terms-of-website">
												Terms of Website
											</a>
										</li>

										<li>
											<a className="text-white transition hover:text-white/60" rel="noopener noreferrer" target='_blank' href="https://polkadot.polkassembly.io/privacy">
												Privacy Policy
											</a>
										</li>
									</ul>
								...
								<ul className="mt-8 space-y-4 text-sm">
									<li>
										...
										>
											...
											<span className="text-white transition group-hover:text-white/60">
