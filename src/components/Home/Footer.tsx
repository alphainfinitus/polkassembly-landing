	...
	return (
		<>
			<div className='w-full -z-0 flex items-center flex-col'>
				...
				<a href='#' className='mb-2 md:mb-10 rounded-full bg-white px-2 py-1 md:px-4 md:py-2 text-sm text-pa-pink font-bold'>
					Contact Us
				</a>
			</div>
				...
				<div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
					<div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
						...
						<div className='md:-mt-10'>
							...
							<ul className="ml-0 mb-4  md:ml-3 flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
								<li>
									<a
										href="/"
										rel="noopener noreferrer"
