	...
	return (
      ...
      <div className="container flex justify-space-between text-black text-center py-3">
        ...
        <div className="ml-auto mr-3 md:mr-6 flex items-center">
          ...
          <Link to='/launch-app' className="hidden md:inline-flex relative items-center justify-center p-4 px-6 py-1 overflow-hidden font-medium text-pa-pink transition duration-300 ease-out border-2 border-pa-pink rounded-full shadow-md group">
          ...
          <Link to='/launch-app' className='block md:hidden text-sm font-normal whitespace-nowrap rounded-md border border-pa-pink hover:text-white hover:bg-pa-pink px-2 py-1'>
            Launch App
          </Link>
        </div>
      </div>
